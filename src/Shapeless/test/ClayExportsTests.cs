...
public class ClayExportsTests(ITestOutputHelper output)
{
    ...
    [Fact]
    public void ParseFromUrlEncodedFormFormat_ReturnOK()
    {
        Assert.Equal(
            ...
            Clay.Parse(
                    "IsDeviceEnable=0&Thresholdvalue=1&DeviceState=0&SurplusParams=&DeviceName=2%E5%B1%82%E8%8C%B6%E6%A5%BC%E7%83%AD%E6%B0%B4%E7%94%A8%E6%B0%B4%E9%87%8F6789&Concentrator=476103385&ProtocolId=888085307&BuildId=524328523&DeviceId=489414407&DeviceCode=6789")
                .ToJsonString());
        ...
        Assert.Equal(
            ...
            Clay.Parse(
                    "datalist%5B0%5D%5BNumber%5D=1&datalist%5B0%5D%5BF_AvgEnergy%5D=2025&datalist%5B0%5D%5BF_TotalNumber%5D=1&datalist%5B0%5D%5BF_TotalEnergy%5D=7.63&datalist%5B1%5D%5BNumber%5D=2&datalist%5B1%5D%5BF_AvgEnergy%5D=2025&datalist%5B1%5D%5BF_TotalNumber%5D=2&datalist%5B1%5D%5BF_TotalEnergy%5D=7.63")
                .ToJsonString());
    }
    ...
    public void Unwrap_WithoutParameters_ReturnOK()
    {
        ...
        var clay6 = Clay.Parse("""
                                 ...
                                 "result" : {
                                   "data_list" : [ {
                                     "contents" : [ {
                                       ...
                                       "sort" : "0",
                                       "type" : "16",
                                       "value" : "[[\"项目\",\"工作内容\",\"工时\",\"预计完成时间点/当前进度/需要资源\"],[\"viofo APP 2.0\",\"鸿蒙app-设备连接逻辑，列表功能实现\",\"3\",\"已完成\"],[\"viofo APP 2.0\",\"鸿蒙app-socket通信，页面监听机制\",\"5\",\"已完成\"]]"
                                     }, {
                                       "key" : "待完成事项",
                                       "sort" : "1",
                                       "type" : "16",
                                       "value" : "[[\"项目\",\"工作内容\",\"工时\",\"预计完成时间点/当前进度/需要资源\"]]"
                                     }, {
                                       "key" : "日报补交日期",
                                       "sort" : "2",
                                       "type" : "5",
                               ...
                               """).Unwrap();
        Assert.Equal(
            "{\"errcode\":0,\"errmsg\":\"ok\",\"result\":{\"data_list\":[{\"contents\":[{\"key\":\"今日工作\",\"sort\":\"0\",\"type\":\"16\",\"value\":[[\"项目\",\"工作内容\",\"工时\",\"预计完成时间点/当前进度/需要资源\"],[\"viofo APP 2.0\",\"鸿蒙app-设备连接逻辑，列表功能实现\",\"3\",\"已完成\"],[\"viofo APP 2.0\",\"鸿蒙app-socket通信，页面监听机制\",\"5\",\"已完成\"]]},{\"key\":\"待完成事项\",\"sort\":\"1\",\"type\":\"16\",\"value\":[[\"项目\",\"工作内容\",\"工时\",\"预计完成时间点/当前进度/需要资源\"]]},{\"key\":\"日报补交日期\",\"sort\":\"2\",\"type\":\"5\",\"value\":\"\"}]}]}}",
            clay6.ToJsonString());
    }
